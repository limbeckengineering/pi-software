...
echo "$(tput setaf 2) This scripts will configure your Raspberry Pi for _________________________.$(tput sgr0)"
...
echo "$(tput setaf 3)Moving Java exectutbles into /home/pi/scripts/java $(tput sgr0)"
